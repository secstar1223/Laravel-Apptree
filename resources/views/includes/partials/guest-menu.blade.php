<header x-data="{ isOpen: false }"  class="bg-white border-b shadow-sm">
    <nav class="flex items-center justify-between p-6 mx-auto max-w-7xl lg:px-8" aria-label="Global">
      ...
      <div class="flex lg:hidden">
        <button x-on:click="isOpen = !isOpen" type="button" class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700">
    ...
    <div 
      ...
      <div class="fixed inset-y-0 right-0 z-10 w-full px-6 py-6 overflow-y-auto bg-white sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
        <div class="flex items-center justify-between">
          ...
          <button x-on:click="isOpen = false"  type="button" class="-m-2.5 rounded-md p-2.5 text-gray-700">
